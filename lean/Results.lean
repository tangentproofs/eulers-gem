...
two-spoke-nonadjacent / two-spoke-adjacent). Adjacent two-spoke is vacuous under
`PrimitiveEdges`. Shoelace ≠ Haar. Classical Pick FAIL. -/
...
twoSpoke-nonadj ∨ twoSpoke-adjacent). -/
